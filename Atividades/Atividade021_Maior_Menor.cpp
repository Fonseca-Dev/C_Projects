...
int main()
{
	...
	if (num1<num2 && num1<num3) cout << endl << "O menor número digitado foi " << num1 << endl;
	else if (num2<num1 && num2<num3) cout << endl << "O menor número digitado foi " << num2 << endl;
	else cout << endl << "O menor número digitado foi " << num3 << endl;
	return 0;
